...
public class HighCardResolverTest {
	...
	public void testExtendsHandValueResolver() throws Exception {
		assertEquals(HandValueResolver.class, HighCardResolver.class.getSuperclass());
	}
	@Test
	public void testIsASingleton() throws Exception {
		assertEquals(0, HighCardResolver.class.getConstructors().length);
		assertEquals(HighCardResolver.class, HighCardResolver.SINGLETON.getClass());
	}
	@Test
	public void testPlayerOneWins() throws Exception {
		...
		assertEquals(Winner.PLAYER_ONE, HighCardResolver.SINGLETON.resolve(hand1, hand2));
	}
	@Test
	public void testPlayerTwoWins() throws Exception {
		...
		assertEquals(Winner.PLAYER_TWO, HighCardResolver.SINGLETON.resolve(hand1, hand2));
	}
	@Test
	public void testPlayerTie() throws Exception {
		...
		assertEquals(Winner.TIE, HighCardResolver.SINGLETON.resolve(hand1, hand2));
	}
}
